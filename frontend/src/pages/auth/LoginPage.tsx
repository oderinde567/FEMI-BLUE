...
export default function LoginPage() {
    ...
    // Use the real login mutation from auth feature
                ...
                <div className="p-8">
                    ...
                    {loginMutation.isError && (
                        <div className="mb-6 flex items-center gap-3 rounded-xl bg-red-500/10 border border-red-500/20 p-4 text-red-400">
                            ...
                            <p className="text-sm">{loginMutation.error?.message || 'Login failed'}</p>
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <button
                            type="button"
                            className="w-full flex items-center justify-center gap-3 rounded-xl border border-slate-600 bg-white py-4 text-slate-900 font-semibold hover:bg-gray-100 transition-colors cursor-pointer"
                        >
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-slate-800/50 px-3 text-slate-500">or continue with email</span>
                            </div>
                        </div>
